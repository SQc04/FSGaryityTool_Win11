    ...
    internal class SettingsCoreServices
    {
        ...
        public static void AddTomlFile()
        {
            ...
            else
            {
                ...
                using (StreamWriter writer = File.CreateText(FSGravityToolsSettingsToml))
                {
        ...
        {
            string data = "0";
            using (StreamReader reader = File.OpenText(FSGravityToolsSettingsToml))
            {
        ...
        public static void CheckSettingsFileVersion()
        {
            ...
            Version FSGrVersion = new Version(MainWindow.FSSoftVersion);
        ...
        public static void UpdateSettingsFile()
        {
            ...
            using (StreamReader reader = File.OpenText(FSGravityToolsSettingsToml))                    //打开TOML文件
            {
            ...
            //更新Toml
            using (StreamWriter writer = File.CreateText(FSGravityToolsSettingsToml))                  //将设置写入TOML文件
            {
